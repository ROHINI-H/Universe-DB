...
CREATE DATABASE students WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLL
ATE = 'C.UTF-8' LC_CTYPE = 'C.UTF-8';
...
--
-- Name: courses_course_id_seq; Type: SEQUENCE; Schema: public; Owner: freec
odecamp
--
...
--
-- Name: courses_course_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Own
er: freecodecamp
--

ALTER SEQUENCE public.courses_course_id_seq OWNED BY public.courses.course_i
d;
...
--
-- Name: majors_major_id_seq; Type: SEQUENCE; Schema: public; Owner: freecod
ecamp
--
...
--
-- Name: majors_major_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner
: freecodecamp
--
...
--
-- Name: students_student_id_seq; Type: SEQUENCE; Schema: public; Owner: fre
ecodecamp
--
...
--
-- Name: students_student_id_seq; Type: SEQUENCE OWNED BY; Schema: public; O
wner: freecodecamp
--

ALTER SEQUENCE public.students_student_id_seq OWNED BY public.students.stude
nt_id;


--
-- Name: courses course_id; Type: DEFAULT; Schema: public; Owner: freecodeca
mp
--

ALTER TABLE ONLY public.courses ALTER COLUMN course_id SET DEFAULT nextval('
...
ALTER TABLE ONLY public.majors ALTER COLUMN major_id SET DEFAULT nextval('pu
blic.majors_major_id_seq'::regclass);


--
-- Name: students student_id; Type: DEFAULT; Schema: public; Owner: freecode
camp
--

ALTER TABLE ONLY public.students ALTER COLUMN student_id SET DEFAULT nextval
('public.students_student_id_seq'::regclass);


--
-- Data for Name: courses; Type: TABLE DATA; Schema: public; Owner: freecode
camp
--
...
--
-- Data for Name: majors; Type: TABLE DATA; Schema: public; Owner: freecodec
amp
--
...
--
-- Data for Name: majors_courses; Type: TABLE DATA; Schema: public; Owner: f
reecodecamp
--
...
--
-- Data for Name: students; Type: TABLE DATA; Schema: public; Owner: freecod
ecamp
--
...
--
-- Name: courses_course_id_seq; Type: SEQUENCE SET; Schema: public; Owner: f
reecodecamp
--
...
--
-- Name: majors_major_id_seq; Type: SEQUENCE SET; Schema: public; Owner: fre
ecodecamp
--
...
--
-- Name: courses courses_pkey; Type: CONSTRAINT; Schema: public; Owner: free
codecamp
--
...
--
-- Name: majors_courses majors_courses_pkey; Type: CONSTRAINT; Schema: publi
...
--
-- Name: majors majors_pkey; Type: CONSTRAINT; Schema: public; Owner: freeco
decamp
--
...
--
-- Name: students students_pkey; Type: CONSTRAINT; Schema: public; Owner: fr
eecodecamp
--
...
--
-- Name: majors_courses majors_courses_course_id_fkey; Type: FK CONSTRAINT; 
Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.majors_courses
    ADD CONSTRAINT majors_courses_course_id_fkey FOREIGN KEY (course_id) REF
ERENCES public.courses(course_id);


--
-- Name: majors_courses majors_courses_major_id_fkey; Type: FK CONSTRAINT; S
chema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.majors_courses
    ADD CONSTRAINT majors_courses_major_id_fkey FOREIGN KEY (major_id) REFER
ENCES public.majors(major_id);


--
-- Name: students students_major_id_fkey; Type: FK CONSTRAINT; Schema: publi
c; Owner: freecodecamp
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_major_id_fkey FOREIGN KEY (major_id) REFERENCES 
public.majors(major_id);
